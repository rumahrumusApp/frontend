        ...
        <div className={style.container}>
            <div className={style.rumus}> 
                ...
                <div className={style.list}>
                    <a className={hover[0]} onClick={(event) => changeDisplay(event, 0)} href="./rumussaya">Rumus Favorit</a>
                    <hr/>
                    <a className={hover[1]} onClick={(event) => changeDisplay(event, 1)} href="./rumussaya">Daftar Rumus yang Dibuat</a>
            </div>
