...
export default function Signup() {
    ...
    const getOccupbyID = async() =>{
        ...
        try {
            const result = await axios.get(`http://localhost:8000/occup/occupById/${router.query.id}`)
    ...
    const EditOccup = async(e) =>{
        ...
        try {
            const data = await axios.post(`http://localhost:8000/occup/editOccup/${router.query.id}`, {
