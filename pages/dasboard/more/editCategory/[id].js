...
export default function Signup() {
    ...
    const getCatbyID = async() =>{
        ...
        try {
            const result = await axios.get(`http://localhost:8000/ct/categById/${router.query.id}`)
    ...
    const EditCategories = async(e) =>{
        ...
        try {
            const data = await axios.post(`http://localhost:8000/ct/editCateg/${router.query.id}`, {
